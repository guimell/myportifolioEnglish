    ...
    <div id="experience" className="section">
      ...
      <div className={styles.containerExperience}>
        ...
        <div className={styles.experience}>
          ...
          <br />
          <p>
            Desenvolver programas para automação de atividades e dar suporte as
            maquinas da empresa.
          </p>
        </div>
      </div>
      <div className={styles.containerExperience}>
        ...
        <div className={styles.experience}>
          ...
          <p>
            ...
            quanto no back end. Participei da criação do aplicativo moviematter,
            e de alguns sites institucionais.
          </p>
        </div>
      </div>
    </div>
